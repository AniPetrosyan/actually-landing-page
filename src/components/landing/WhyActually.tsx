...
const differentiators = [
  {
    ...
    description: "While others provide summaries, Actually directly edits your documents with precise, contextual changes.",
    stat: "Direct edits",
  ...
  },
  {
    ...
    description: "Our AI agents understand your document history, tone, and objectives, collaborating with you over time.",
    stat: "Context-aware",
  ...
  },
  {
    ...
    description: "Your documents change as the world does. No waiting for updates or manual refresh cycles.",
    stat: "Real-time",
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            We're not building another summarization tool. We're creating the future 
            of living documents that evolve with your business.
          </p>
        </div>
